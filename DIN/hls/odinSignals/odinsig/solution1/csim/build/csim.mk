...
HLS_SOURCES = ../../../../top_test_ddr.c ../../../../top.c
...
$(ObjDir)/top_test_ddr.o: ../../../../top_test_ddr.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../top_test_ddr.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/top_test_ddr.d
