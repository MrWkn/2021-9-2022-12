...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("data", 32, hls_out, 2, "ap_none", "out_data", 1),
	Port_Property("req", 32, hls_out, 3, "ap_none", "out_data", 1),
	Port_Property("ack", 32, hls_in, 4, "ap_none", "in_data", 1),
	Port_Property("SCHED_FULL", 32, hls_in, 6, "ap_none", "in_data", 1),
	Port_Property("NEUR_EVENT_OUT", 32, hls_in, 7, "ap_none", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "send";
