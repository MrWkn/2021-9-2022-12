...
#
# Generated by export_simulation on Wed Apr 27 09:10:39 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './neuron_mem_0.sh' script.

./neuron_mem_0.sh -reset_run
...
./neuron_mem_0.sh -noclean_files

For more information on the script, please type './neuron_mem_0.sh -help'.
