...
#
# Generated by export_simulation on Tue Apr 26 23:16:21 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './synapse_mem_0.sh' script.

./synapse_mem_0.sh -reset_run
...
./synapse_mem_0.sh -noclean_files

For more information on the script, please type './synapse_mem_0.sh -help'.
