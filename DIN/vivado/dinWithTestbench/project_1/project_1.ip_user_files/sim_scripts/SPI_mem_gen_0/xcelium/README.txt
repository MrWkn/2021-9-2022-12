...
#
# Generated by export_simulation on Sun Oct 30 20:49:02 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './SPI_mem_gen_0.sh' script.

./SPI_mem_gen_0.sh -reset_run
...
./SPI_mem_gen_0.sh -noclean_files

For more information on the script, please type './SPI_mem_gen_0.sh -help'.
