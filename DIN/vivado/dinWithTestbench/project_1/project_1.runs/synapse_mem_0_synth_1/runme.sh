...
HD_PWD='D:/Vivado_project/test_ODIN5_9/project_1/project_1.runs/synapse_mem_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log synapse_mem_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source synapse_mem_0.tcl
