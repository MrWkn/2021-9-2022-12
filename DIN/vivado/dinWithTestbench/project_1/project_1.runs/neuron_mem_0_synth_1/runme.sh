...
HD_PWD='E:/EDAproject/test/test_ODIN/test_ODIN.runs/neuron_mem_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neuron_mem_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neuron_mem_0.tcl
