...
HD_PWD='D:/Vivado_project/test_ODIN5_9/project_1/project_1.runs/SPI_mem_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_mem_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_mem_gen_0.tcl
